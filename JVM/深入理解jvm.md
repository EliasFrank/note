...
* 通常，访问直接内存的速度会优先于java堆，即读写性能提高
    ...
    <img src="upload/image-20210825182745550.png" alt="image-20210825182745550" style="zoom:50%;" />
...
* 采用基于计数器的热点探测，HotSpot VM将会为每一个方法都建立2个不同类型的计数器，分别为方法调用计数器（Invocation Counter）和回边计数器（Back Edge Counter）
    ...
    * 方法调用计数器用于统计方法的调用次数
        ...
        <img src="upload/image-20210830150748395.png" alt="image-20210830150748395" style="zoom:53%;" />
...
<img src="upload/image-20210906165508688.png" alt="image-20210906165508688" style="zoom:50%;" />
...
<img src="upload/image-20210908104733229.png" alt="image-20210908104733229" style="zoom:50%;" />

<img src="upload/image-20210908104932526.png" alt="image-20210908104932526" style="zoom:50%;" />
...
<img src="upload/image-20210908110706910.png" alt="image-20210908110706910" style="zoom:50%;" />
...
<img src="upload/image-20210908141243152.png" alt="image-20210908141243152" style="zoom:53%;" />
...
<img src="upload/image-20210908143248920.png" alt="image-20210908143248920" style="zoom:53%;" />
...
<img src="upload/image-20210908151033823.png" alt="image-20210908151033823" style="zoom:63%;" />
...
<img src="upload/image-20210908170145188.png" alt="image-20210908170145188" style="zoom:50%;" />
...
YGC时，首先G1停止应用程序的执行（stw），G1创建回收集（Collection Set），回收集是指需要被回收的内存分段的集合，年轻代回收过程的收集包含年轻代Eden区和Survivor区所有的内存分段
...
<img src="upload/image-20210908222131267.png" alt="image-20210908222131267" style="zoom: 100%;" />
...
* 由于老年代中的内存分段默认分8次回收，G1会优先回收垃圾多的内存分段。垃圾占内存分段比例越高的，越会被先回收。并且有一个阈值会决定内存分段是否被回收，-XX:G1MixedGCLiveThresholdPercent
    ...
    默认为65%，意思是垃圾占内存分段比例要达到656%才会被回收。如果垃圾占比太低，意味着存活的对象占比高，在复制的时候会花费更多的时间
...
<img src="upload/image-20210909112018965.png" alt="image-20210909112018965" style="zoom:50%;" />
