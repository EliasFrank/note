### 自我介绍
  ...
  面试官你好，我叫黄雷，就读于江西农业大学软件学院。大学三年来，我刻苦学习，成绩优异，曾多次获得奖学金。在编程方面，有着浓厚的兴趣。在兴趣的驱使下，我熟悉了java语言的使用，能使用 Spring、SpringMVC 和 MyBatis 等开源框架进行项目开发，对关系型数据库MySQL和非关系型数据库redis有一定的了解。
